...
import { createLinearTicket } from "@/lib/ai/tools/create-linear-ticket";
import { searchLinearIssuesTool } from "@/lib/ai/tools/search-linear-issues";
  ...
  try {
    ...
    if (chat) {
      ...
      await saveChat({
        ...
        title,
        visibility: "private", // Default to private for support tickets
      });
    }
        ...
        const result = streamText({
          ...
          experimental_activeTools:
            selectedChatModel === "chat-model-reasoning"
              ? []
              : ["searchLinearIssues", "createLinearTicket"],
          experimental_transform: smoothStream({ chunking: "word" }),
          tools: {
            searchLinearIssues: searchLinearIssuesTool({
              selectedProject,
            }),
            createLinearTicket: createLinearTicket({
              session,
              dataStream,
              selectedProject,
              chatId: id,
