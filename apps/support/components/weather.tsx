      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            <div
              className={cx("text-white/90", { "text-yellow-200": isDay, "text-blue-200": !isDay })}
            >
          ...
          <div className="text-right">
            <div className="text-white/90 text-sm font-medium">H: {n(currentHigh)}°</div>
            <div className="text-white/70 text-sm">L: {n(currentLow)}°</div>
          </div>
        </div>

        <div className="bg-white/10 rounded-2xl p-4 backdrop-blur-sm">
          <div className="text-white/80 text-sm mb-3 font-medium">Hourly Forecast</div>
